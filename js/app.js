   ...
   restartBtn.addEventListener("click", function() {startingGame(); TIME.innerHTML = minutes + ':' + seconds;});
...
function scoreData() {
   ...
   function youWin(){ 
       ...
       if (matchedCard.length == 16) {
        ...
        gimme3Stars();
        stopTimer();
        setTimeout(function(){stopTimer(); restartStars();  window.location.href = '#winModal'},1000); 
          }
   ...
   function youLost() {
           ...
           setTimeout(function(){stopTimer(); window.location.href = '#looseModal';},1000);
